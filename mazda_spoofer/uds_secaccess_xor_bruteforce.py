# sample: python3 uds_secaccess_xor_bruteforce.py --channel can0 --req-id 0x7E1 --resp-id 0x7E9 --seed-sf 0x01 --key-sf 0x04 --key-len 4 --per-seed-attempts 500 --rate 0.01
#!/usr/bin/env python3
